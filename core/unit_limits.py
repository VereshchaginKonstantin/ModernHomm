#!/usr/bin/env python3
"""
Сервис для управления лимитами найма юнитов.

Содержит функции инициализации, разблокировки и управления лимитами,
которые используются и в web, и в jobs контейнерах.
"""
