...
<nav class="navbar">
    <div class="nav-links">
        ...
        <div class="nav-dropdown">
            <a href="#" class="nav-link {{ 'active' if active_page in ['races', 'unit_levels', 'leaderboard', 'fields', 'elements', 'challenges'] else '' }}">⚙️ Админ настройки ▾</a>
            <div class="dropdown-content">
                ...
                <a href="{{ url_for('elements.elements_list') }}" class="{{ 'active' if active_page == 'elements' else '' }}">🎨 Редактор элементов</a>
                <a href="{{ url_for('fields.fields_list') }}" class="{{ 'active' if active_page == 'fields' else '' }}">🗺️ Редактор полей</a>
                <a href="{{ url_for('challenges.challenges_list') }}" class="{{ 'active' if active_page == 'challenges' else '' }}">⚔️ Челленджи</a>
                {% endif %}
